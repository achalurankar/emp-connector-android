 ...
 */
package com.andromeda.subscriber.lib;
...
public class LoginHelper {
    ...
    public static BayeuxParameters login(URL loginEndpoint, String username, String password,
        ...
        try {
            ...
            /** These two lines were throwing org.xml.sax.SAXNotRecognized exception so I commented it out
             * and it worked I hope I don't have to face any consequences because
             * I have no clue what SAX actually is and what is it
             * doing here, Whats its purpose similar to my existence */
